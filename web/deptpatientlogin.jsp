...
<title>Global Cure Hospitals | Admin Login</title>
</head>
	...
	<div class="column-left">
		...
		<div class="column-right">
			...
			<div class="box-in">
				...
				<h2>Enter the patient login details to get the information</h2>
				<form action="deptadmin.jsp" method="post">

Username: <input name="name" size="30" type="text"></br><p></p>
Password: <input name="id" size="30" type="password"></br><p></p>
<input name="submit" value="LOGIN" type="submit">
</form>

<p></p>
<h2></>Logout from the session</h2>
<form action="departmentlogin.jsp" method="post">
