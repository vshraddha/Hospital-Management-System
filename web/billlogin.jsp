	...
	<div class="column-left">
		...
		<div class="column-right">
			...
			<div class="box-in">
				...
				<h2>Enter the billing admin login details</h2>
				<form action="billinfo.jsp" method="post">

Username: <input name="bname" size="30" type="text"></br><p></p>
Password: <input name="bid" size="30" type="password"></br><p></p>
