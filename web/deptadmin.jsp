 ...
 count++;         
  ...
  if(count>0)         
   ...
   out.println("welcome "+uname);          
    ...
    {                       
    response.sendRedirect("deptpatientlogin.jsp?msg=Invalid Username or Password");          
    }
}catch(Exception e){
}
%>
...
ResultSet rs = st.executeQuery("SELECT * FROM db2admin.patient WHERE NAME='"+name+"' AND ID='"+id+"'");
%>
...
<%
 ...
 <form method="post" action="admininsert.jsp">
<table align="center">
<tr><td>Id</td>
<td><input type="text" name="id"></td>

<tr><td>Department</td><td><input type="text" name="department"></td>
</tr>
...
<tr><td>Room no</td>
<td><input type="text" name="roomno"></td></tr>
...
<form action="deptpatientlogin.jsp" method="post">
