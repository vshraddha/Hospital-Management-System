	...
	<div class="column-left">
		...
		<div class="column-right">
			...
			<div class="box-in">
				...
				<h2>Enter the clerk login details to access the patient information</h2><p></p>
				<form action="clerkinfo.jsp" method="post">
				
Username: <input name="cname" size="30" type="text"></br><p></p>
Password: <input name="cid" size="30" type="password"></br><p></p>
