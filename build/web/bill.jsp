 ...
 count++;         
  ...
  if(count>0)         
   ...
   out.println("welcome "+uname);          
    ...
    {                       
    response.sendRedirect("billpatientlogin.jsp?msg=Invalid Username or Password");          
    }
}catch(Exception e){
}
%>
...
while(rs.next()){
 ...
 <tr>
<td>
 Drugs </td><td><%= rs.getString(1) %> </td></tr>

<tr>
<td> Tests </td><td> <%= rs.getString(2) %> </td></tr>
...
<tr><td>Drug Amount</td>
<td><input type="text" name="drugamount"></td>

<tr><td>Test Amount</td><td><input type="text" name="testamount"></td>
</tr>

<tr><td>Room Rent</td><td><input type="text" name="roomamount"></td>
</tr>
