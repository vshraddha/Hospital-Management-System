...
<title>Global Cure Hospitals | Doctor Login</title>
</head>
	...
	<div class="column-left">
		...
		<div class="column-right">
			...
			<div class="box-in">
				...
				<h2>Enter the doctor login details to access the patient information</h2>
				<form action="doctorinfo.jsp" method="post">

Username: <input name="dname" size="30" type="text"></br><p></p>
Password: <input name="did" size="30" type="password"></br><p></p>
