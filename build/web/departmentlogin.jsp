	...
	<div class="column-left">
		...
		<div class="column-right">
			...
			<div class="box-in">
				...
				<h2>Enter the admin login details to access the patient information</h2>
				<form action="deptinfo.jsp" method="post">

Username: <input name="aname" size="30" type="text"></br><p></p>
Password: <input name="aid" size="30" type="password"></br><p></p>
