...
<title>Global Cure Hospitals | Bill Login</title>
</head>
	...
	<div class="column-left">
		...
		<div class="column-right">
			...
			<div class="box-in">
				...
				<h2>Enter the patient login details for billing details</h2>
...
<h2></>Logout from the billing admin session</h2>
<form action="billlogin.jsp" method="post">
